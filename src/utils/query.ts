import { AbiEvent, Address, GetLogsReturnType, PublicClient } from "viem"
...
export const getLogsBatched = async <E extends Readonly<AbiEvent[]>>(client: PublicClient, fromBlock: bigint, toBlock: bigint, query: EventQuery<E>, batchSize: bigint = 10000n): Promise<QueryResult<E>> => {
    const logs = []
